        ...
        <div className="lg:flex-1">
          <div className="space-y-6">
            <TextBlock>
              ...
              <strong>freelance web developer</strong> and <strong>UI/UX designer</strong>. In 2016
              I became interested in web technologies and started implementing my own websites in my
              spare time. In 2018 I registered a <strong>business</strong> and since then I&apos;ve
              been implementing websites for companies and organizations from all over Germany.
              Today, I increasingly implement websites and web applications that I program from
              scratch. For this I use technologies like{' '}
