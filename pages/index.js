...
const Home = () => (
  <Layout>
    ...
    <section id="home" className="px-4 py-24 sm:px-8 md:px-12 lg:px-24 xl:px-32">
      <h1 className="font-gilroy text-5xl font-extrabold md:text-6xl lg:text-7xl xl:text-8xl">
        Hi, I&apos;m Robin.
      </h1>
    ...
    <section id="about" className="mt-48 px-4 py-24 sm:px-8 md:px-12 lg:px-24 xl:px-32">
      <h2 className="text-center font-gilroy text-5xl font-extrabold md:text-6xl lg:text-7xl xl:text-8xl">
        About me
      </h2>
    </section>
    ...
    <section id="contact" className="mt-48 px-4 py-24 sm:px-8 md:px-12 lg:px-24 xl:px-32">
      <h2 className="font-gilroy text-5xl font-extrabold md:text-6xl lg:text-7xl xl:text-8xl">
        Contact
      </h2>
    </section>
  </Layout>
