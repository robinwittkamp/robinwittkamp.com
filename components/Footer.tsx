      ...
      <div className="mx-auto max-w-screen-xl ">
        ...
        <div className="space-y-8 md:flex md:flex-wrap md:justify-between lg:space-y-0">
          ...
          <div className="md:flex-[1_1_100%] lg:flex-[2_2_0%]">
            ...
            <span className="mt-8 block max-w-[18rem] text-neutral-400">
          ...
          <div className="md:flex-1 lg:flex-1">
            {/* Main navigation */}
            <span className="block font-bold text-neutral-200">Menu</span>
            <ul className="mt-2">
          ...
          <div className="md:flex-1 lg:flex-1">
            {/* Legal navigation */}
            <span className="block font-bold text-neutral-200">Legal</span>
            <ul className="mt-2">
          ...
          <div className="md:flex-1 lg:flex-1">
            {/* Languages */}
            <span className="block font-bold text-neutral-200">Languages</span>
            <ul className="mt-2">
              {languages.map((item) => (
                <li key={item.name}>
                  <Link href="/#" className="inline-block py-2 text-neutral-400 hover:text-white">
                    {item.name}
                  </Link>
                </li>
              ))}
