...
const PrivacyPolicyContent = (): ReactElement => (
  <>
    <Heading variant="h1">Datenschutz</Heading>
    <Heading variant="h4">1. Datenschutz auf einen Blick</Heading>
    <Heading variant="h6">Allgemeine Hinweise</Heading>
    <p>
    ...
    <Heading variant="h6">Datenerfassung auf dieser Website</Heading>
    <p>
    ...
    <Heading variant="h6">Analyse-Tools und Tools von Drittanbietern</Heading>
    <p>
      Beim Besuch dieser Website kann Ihr Surf-Verhalten statistisch ausgewertet werden. Das
      geschieht vor allem mit Cookies und mit sogenannten Analyseprogrammen.
    </p>
    <p>
    ...
    <Heading variant="h6">Externes Hosting</Heading>
    <p>
    ...
    <Heading variant="h4">3. Allgemeine Hinweise und Pflichtinformationen</Heading>
    <Heading variant="h6">Datenschutz</Heading>
    <p>
    ...
    <Heading variant="h6">Hinweis zur verantwortlichen Stelle</Heading>
    ...
    <Heading variant="h6">Speicherdauer</Heading>
    <p>
    ...
    <Heading variant="h6">Hinweis zur Datenweitergabe in die USA und sonstige Drittstaaten</Heading>
    <p>
      ...
      gerichtlich vorgehen könnten. Es kann daher nicht ausgeschlossen werden, dass US-Behörden (z.
      B. Geheimdienste) Ihre auf US-Servern befindlichen Daten zu Überwachungszwecken verarbeiten,
      auswerten und dauerhaft speichern. Wir haben auf diese Verarbeitungstätigkeiten keinen
      Einfluss.
    </p>
    <Heading variant="h6">Widerruf Ihrer Einwilligung zur Datenverarbeitung</Heading>
    <p>
    ...
    <Heading variant="h6">Beschwerderecht bei der zuständigen Aufsichtsbehörde</Heading>
    <p>
    ...
    <Heading variant="h6">Recht auf Datenübertragbarkeit</Heading>
    <p>
    ...
    <Heading variant="h6">SSL- bzw. TLS-Verschlüsselung</Heading>
    <p>
    ...
    <Heading variant="h6">Auskunft, Löschung und Berichtigung</Heading>
    <p>
    ...
    <Heading variant="h6">Recht auf Einschränkung der Verarbeitung</Heading>
    <p>
    ...
    <Heading variant="h6">Widerspruch gegen Werbe-E-Mails</Heading>
    <p>
    ...
    <Heading variant="h4">4. Datenerfassung auf dieser Website</Heading>
    ...
    <p>
      ...
      oder zur Bereitstellung bestimmter, von Ihnen erwünschter Funktionen (funktionale Cookies, z.
      B. für die Warenkorbfunktion) oder zur Optimierung der Website (z. B. Cookies zur Messung des
    ...
    <Heading variant="h6">Server-Log-Dateien</Heading>
    <p>
    ...
    <Heading variant="h6">Kontaktformular</Heading>
    <p>
    ...
    <Heading variant="h6">Anfrage per E-Mail, Telefon oder Telefax</Heading>
    <p>
    ...
    <Heading variant="h4">5. eCommerce und Zahlungs­anbieter</Heading>
    <Heading variant="h6">Verarbeiten von Daten (Kunden- und Vertragsdaten)</Heading>
    <p>
