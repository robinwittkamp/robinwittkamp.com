...
const PrivacyPolicyContent = (): ReactElement => (
  <>
    ...
    <Heading variant="h4">1. An overview of data protection</Heading>
    <Heading variant="h6">General information</Heading>
    <p>
      The following information will provide you with an easy to navigate overview of what will
      happen with your personal data when you visit this website. The term “personal data” comprises
      all data that can be used to personally identify you. For detailed information about the
      subject matter of data protection, please consult our Data Protection Declaration, which we
      have included beneath this copy.
    </p>
    <Heading variant="h6">Data recording on this website</Heading>
    <p>
      <strong>Who is responsible for the recording of data on this website?</strong>
    </p>
    <p>
    ...
    <p>
      ...
      data processing, you have the option to revoke this consent at any time, which shall affect
      all future data processing. Moreover, you have the right to demand that the processing of your
    ...
    <Heading variant="h6">Analytics and third-party tools</Heading>
    <p>
      When visiting our website, statistical analyses may be made of your surfing behavior. This
      happens primarily using cookies and analytics. The analysis of your surfing behavior is
      usually anonymous, i.e. we will not be able to identify you from this data. You can object to
      this analysis or prevent it by not using certain tools. Details can be found in our privacy
      policy under the heading “Third-party modules and analytics.”
    </p>
    <p>
      You can object to this analysis. We will inform you below about how to exercise your options
      in this regard.
    </p>
    <Heading variant="h4">2. Hosting</Heading>
    <Heading variant="h6">External Hosting</Heading>
    <p>
    ...
    <p>
      ...
      customers (Art. 6 para. 1 lit. b DSGVO) and in the interest of secure, fast and efficient
      provision of our online services by a professional provider (Art. 6 para. 1 lit. f DSGVO).
    </p>
    <p>
    ...
    <p>
      We have concluded a data processing agreement (DPA) with the above-mentioned provider. This is
      a contract mandated by data privacy laws that guarantees that they process personal data of
      our website visitors only based on our instructions and in compliance with the GDPR.
    </p>
    <Heading variant="h4">3. General information and mandatory information</Heading>
    <Heading variant="h6">Data protection</Heading>
    <p>
    ...
    <Heading variant="h6">Notice concerning the party responsible for this website</Heading>
    ...
    <Heading variant="h6">Storage duration</Heading>
    <p>
      Unless a more specific storage period has been specified in this privacy policy, your personal
      data will remain with us until the purpose for which it was collected no longer applies. If
      you assert a justified request for deletion or revoke your consent to data processing, your
      data will be deleted, unless we have other legally permissible reasons for storing your
      personal data (e.g., tax or commercial law retention periods); in the latter case, the
    ...
    <p>
      ...
      to that in the EU cannot be guaranteed. For instance, U.S. enterprises are under a mandate to
      release personal data to the security agencies and you as the data subject do not have any
      litigation options to defend yourself in court. Hence, it cannot be ruled out that U.S.
      agencies (e.g., the Secret Service) may process, analyze, and permanently archive your
      personal data for surveillance purposes. We have no control over these processing activities.
    </p>
    <Heading variant="h6">Revocation of your consent to the processing of your data</Heading>
    <p>
    ...
    <p>
      ...
      PURPOSES OF SUCH ADVERTISING. THIS ALSO APPLIES TO PROFILING TO THE EXTENT THAT IT IS
      AFFILIATED WITH SUCH DIRECT ADVERTISING. IF YOU OBJECT, YOUR PERSONAL DATA WILL SUBSEQUENTLY
      NO LONGER BE USED FOR DIRECT ADVERTISING PURPOSES (OBJECTION PURSUANT TO ART. 21 SECT. 2
      GDPR).
    </p>
    <Heading variant="h6">Right to log a complaint with the competent supervisory agency</Heading>
    <p>
    ...
    <Heading variant="h6">Right to data portability</Heading>
    <p>
    ...
    <Heading variant="h6">SSL and/or TLS encryption</Heading>
    <p>
    ...
    <Heading variant="h6">Right to demand processing restrictions</Heading>
    <p>
    ...
    <Heading variant="h6">Rejection of unsolicited e-mails</Heading>
    <p>
      We herewith object to the use of contact information published in conjunction with the
      mandatory information to be provided in section “Information Required by Law” to send us
      promotional and information material that we have not expressly requested. The operators of
      this website and its pages reserve the express right to take legal action in the event of the
      unsolicited sending of promotional information, for instance via SPAM messages.
    </p>
    <Heading variant="h4">4. Recording of data on our website</Heading>
    <Heading variant="h6">Cookies</Heading>
    <p>
    ...
    <p>
      ...
      cookies are placed and to permit the acceptance of cookies only in specific cases. You may
      also exclude the acceptance of cookies in certain cases or in general or activate the delete
    ...
    <Heading variant="h6">Server log files</Heading>
    <p>
    ...
    <Heading variant="h6">Contact form</Heading>
    <p>
    ...
    <Heading variant="h6">Request by e-mail, telephone or fax</Heading>
    <p>
    ...
    <p>
      The processing of these data is based on Art. 6 para. 1 lit. b GDPR, if your request is
      related to the execution of a contract or if it is necessary to carry out pre-contractual
      measures. In all other cases, the processing is based on your consent (Article 6 (1) a GDPR)
      and/or on our legitimate interests (Article 6 (1) (f) GDPR), since we have a legitimate
    ...
    <p>
      ...
      completion of your request). Mandatory statutory provisions - in particular statutory
      retention periods - remain unaffected.
    </p>
    <Heading variant="h4">5. eCommerce and payment service providers</Heading>
    <Heading variant="h6">Processing of data (customer and contract data)</Heading>
    <p>
      We collect, process and use personal data only to the extent necessary for the establishment,
      ...
      concerning the use of this website (usage data) only to the extent that this is necessary to
    ...
    <p>
      ...
      consented to the transfer. Any sharing of your data with third parties in the absence of your
